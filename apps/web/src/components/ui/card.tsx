...
export function Card({ variant = 'default', className = '', children, ...props }: CardProps) {
  const variantStyles = {
    ...
    paper: 'bg-paper-warm rounded-xl shadow-paper paper-texture',
    notebook: 'bg-white rounded-xl shadow-paper notebook-lines border border-ink-100',
    folded: 'bg-white rounded-xl shadow-paper border border-ink-100 folded-corner',
  };
